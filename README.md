...
<body>
    <div id="characterSelection">
        ...
        <label>
            <input type="radio" name="character" value="tobi"> Tobi
        </label>
    </div>
    ...
    <img id="tobiImage" src="https://e7.pngegg.com/pngimages/739/600/png-clipart-deidara-obito-uchiha-itachi-uchiha-madara-uchiha-sasuke-uchiha-naruto-orange-chibi-thumbnail.png" style="display: none; width: 75px; height: 75px;">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const tobiRadio = document.querySelector('input[value="tobi"]');
            ...
            const tobiImage = document.getElementById("tobiImage");
            ...
            function changePlayerImage() {
                ...
                } else if (tobiRadio.checked) {
                    selectedPlayerImage = tobiImage;
                } else {
